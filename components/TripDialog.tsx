...
const TripDialog = ({ trip, trigger, className }: TripDialogProps) => {
  return (
    <Dialog>
      ...
      <DialogContent className={cn("sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl max-h-[90vh] overflow-y-auto scrollbar-hide", className)}>
        <DialogHeader>
        ...
        <div className="space-y-6">
          ...
          {trip.description && (
            <div className="space-y-3">
              <h3 className="text-xl font-semibold">旅行心得</h3>
